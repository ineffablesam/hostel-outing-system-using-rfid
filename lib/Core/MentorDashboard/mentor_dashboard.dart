  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Provider.of<MentorProvider>(context, listen: false).fetchData();
        },
      ...
      body: Consumer<MentorProvider>(
        builder: (context, mentorProvider, child) {
          if (mentorProvider.isLoading) {
          ...
          } else if (mentorProvider.mentorData == null) {
            return Center(
          ...
          } else if (mentorProvider.isError) {
            return Center(
                child: Text('No Active Leave Requests',
                    style: GoogleFonts.poppins(
                      fontSize: 20.sp,
            ...
            return ListView.builder(
              itemCount: mentorProvider.mentorData!.length,
              itemBuilder: (context, index) {
                final mentorObject = mentorProvider.mentorData![index];
